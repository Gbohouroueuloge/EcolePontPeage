...
- **Financière** : encaissement multi-modes (espèces, carte, abonnement, etc.)
- **Administrative** : gestion des agents et des superviseurs, planification des équipes et rapports de performance
