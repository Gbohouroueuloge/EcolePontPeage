...
$navLinks = [
  ['text' => 'Vue generale', 'isTitle' => true],
  ['text' => 'Dashboard', 'icon' => 'dashboard', 'link' => '', 'isTitle' => false],
  ['text' => 'Historiques', 'icon' => 'history', 'link' => 'historiques.php', 'isTitle' => false],
  ['text' => 'Messages', 'icon' => 'mail', 'link' => 'messages.php', 'isTitle' => false, 'badge' => $unreadNotifications],
  ['text' => 'Gestion', 'isTitle' => true],
  ['text' => 'Operateurs', 'icon' => 'engineering', 'link' => 'operateurs.php', 'isTitle' => false],
  ['text' => 'Superviseurs', 'icon' => 'supervisor_account', 'link' => 'superviseurs.php', 'isTitle' => false],
  ['text' => 'Tarifs', 'icon' => 'local_atm', 'link' => 'tarifs.php', 'isTitle' => false],
  ['text' => 'Systeme', 'isTitle' => true],
  ['text' => 'Parametres', 'icon' => 'settings', 'link' => 'parametres.php', 'isTitle' => false],
];
...
<body class="bg-surface font-body text-on-surface">
  ...
  <aside id="sidebarMobile"
    ...
    <?php require __DIR__ . '/asideAdmin.php'; ?>
  </aside>

  <aside class="fixed hidden left-0 top-0 h-screen w-60 bg-primary z-50 md:flex flex-col shadow-[0_0_20px_rgba(201,144,26,0.15)]">
    <?php require __DIR__ . '/asideAdmin.php'; ?>
  </aside>
  ...
  <header class="fixed top-0 left-0 md:left-60 right-0 h-16 bg-[#fef9f1] flex justify-between items-center px-8 z-40">
    <div class="flex items-center gap-8 flex-1">
      ...
      <div>
        ...
        <p class="hidden lg:block text-[10px] uppercase tracking-[0.24em] text-on-surface-variant font-bold">
          <?= htmlspecialchars($bridgeName) ?>
        </p>
      </div>

      <form action="/pages/admin/historiques.php" class="relative w-full max-w-md hidden md:block">
    ...
    <div class="flex items-center gap-6">
      ...
      <a href="/pages/admin/messages.php" class="relative hidden sm:inline-flex items-center justify-center text-primary">
        <span class="material-symbols-outlined">mail</span>
        <?php if ($unreadNotifications > 0) : ?>
          <span class="absolute -top-2 -right-2 min-w-5 h-5 px-1 rounded-full bg-error text-white text-[10px] font-bold flex items-center justify-center">
