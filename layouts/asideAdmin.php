<div class="p-8 py-4 flex items-center gap-3">
  <a href="/pages/admin/" class="flex items-center gap-4">
    <img class="w-10 h-10 flex items-center justify-center rounded-lg" src="/assets/svg/peage_bridge_logo_africain.svg" alt="">
    <div>
      <h1 class="font-headline text-xl font-black text-on-primary tracking-tight leading-none">Peage Bridge</h1>
    </div>
  </a>
</div>
    ...
    <?php else : ?>
      <a
        ...
        <?php if (!empty($link['badge'])) : ?>
          <span class="ml-auto min-w-5 h-5 px-1 rounded-full bg-secondary text-primary text-[10px] font-black flex items-center justify-center">
...
<div class="p-6 -mb-6 bg-white/5 mt-auto">
  <div class="flex items-center gap-3">
    <a href="" class="relative inline-flex group cursor-pointer">
