...
<body class="bg-surface font-body text-on-surface">
  ...
  <aside class="fixed hidden left-0 top-0 h-screen w-60 bg-primary dark:bg-primary z-50 md:flex flex-col shadow-[0_0_20px_rgba(201,144,26,0.15)]">
  ...
  <header class="fixed top-0 md:left-60 right-0 h-16 bg-[#fef9f1] flex justify-between items-center px-8 z-40">
    <div class="flex items-center gap-8 flex-1">
      <h2 class="hidden md:block text-2xl font-black text-primary font-headline">
        <?= $title ?>
      </h2>
    ...
    <div class="flex items-center gap-6">
      <div
        class="flex items-center gap-2 px-3 py-1.5 bg-surface-container-highest rounded-full text-xs font-bold text-primary">
