    ...
    <form id="payment-form" action="" method="POST" autocomplete="off" novalidate
      ...
      <div class="flex flex-col gap-2">
        ...
        <div class="grid grid-cols-2 gap-2.5" role="radiogroup">
          ...
          <label id="card-Abonnement" data-mode="Mobile Money"
            class="flex flex-col items-center justify-center gap-1 py-4 px-2 rounded-xl border-2 border-outline-variant bg-surface-container-low text-on-surface-variant cursor-pointer transition-all duration-200">
            <input type="radio" name="mode_paiement" value="Mobile Money" class="sr-only" />
            <span class="material-symbols-outlined text-2xl" style="font-variation-settings:'FILL' 1;">mobile</span>
            <span class="text-[10px] font-headline font-bold uppercase tracking-wider">Mobile Money</span>
          </label>
        </div>
      </div>
