  ...
  <div class="flex items-end justify-between">
    <div class="flex flex-col gap-2">
      <div class="flex items-center gap-1.5">
        <span class="material-symbols-outlined text-secondary text-sm"><?= $modeIcon ?></span>
        <span class="text-xs font-medium text-slate-600"><?= htmlspecialchars($passage->mode_paiement) ?></span>
      </div>
